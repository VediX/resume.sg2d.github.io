...
### Зарплата/стоимость услуг: от 1500 руб/час

- [Форма расчёта зарплаты/стоимости услуг](https://resume.sg2d.ru/salary/)
...
* На связи могу быть с 9 до 21ч. Перерывы входят в почасовую оплату: для занятости 2-4 часа/день перерыв 5 минут/час, 4-6 часов - до 10 минут/час, 6-8 часов - 10-15 мин/час.
* В приоритете предложения с постоянной работой с 2-6 часовым рабочим днём без совместительства (без совмещения с другой работой!). В случае full-time'а предлагаю сначала part-time, что бы понять - подходим мы друг другу или нет.
...
* Почасовая ставка в резюме указана для 4-х часового рабочего дня и удалённой работы (от 120т.р./месяц после удержания налогов).
* При фиксированном окладе ставка варьируется в зависимости от минимально оплачиваемых часов.
* В приоритете удалённая работа (скидка 25%), релокация очень дорого (наценка +100%, за границу +200%)! Для работы в офисе/фуллтайм з/п ожидания могут быть выше в несколько раз!
...
* Ежегодная индексация з/п минимум на ключевую ставку ЦБ РФ (на 2024 год - около 16% годовых).
* Также повышение почасовой оплаты при улучшении уровня владения какой-либо ключевой технологией (junior->middle->senior).
* Рассчитать примерную ожидаемую стоимость моих услуг можно здесь: [https://resume.sg2d.ru/salary](https://resume.sg2d.ru/salary)
