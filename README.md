...
* Для начала предлагаю part-time что бы понять - подходим мы друг другу или нет.
...
* legacy-код интересен только при повышенной з/п в зависимости от его количества!
