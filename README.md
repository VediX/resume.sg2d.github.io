...
* Обычно заключаю договор услуг как самозанятый, но при заключении трудового договора скидка 10%, для ИП наценка +15%.
* В приоритете предложения с постоянной работой с 4 часовым рабочим днём (без совместительства! ставка выгоднее на 20-40% чем на фуллтайме).
* При почасовой оплате почасовая ставка с наценкой +30%. При фиксированном окладе ставка варьируется в зависимости от минимально оплачиваемых часов. Рассчитать примерную ожидаемую стоимость моих услуг можно здесь: [https://resume.sg2d.ru/salary](https://resume.sg2d.ru/salary)
* Вместо full-time'а предлагаю сначала part-time (без совместительства!), что бы понять - подходим мы друг другу или нет, к тому же расценки на part-time выгоднее (рейт).
...
* В приоритете удалённая работа (скидка 25%), релокация очень дорого (наценка +100%, за границу +200%)!
...
* Ежегодная индексация з/п с учётом инфляции (как минимум).
